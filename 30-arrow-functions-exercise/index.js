...
const timeToSeconds = (hourParam =0, minuteParam=0) =>{
   if(hourParam && minuteParam){
       let h = hourParam * 60*60;
       let m = minuteParam * 60;
       return h +m;

   }else if(minuteParam) {
       return minuteParam * 60;

   }else if(hourParam){
       return hourParam* 60*60;
   } else {
       return hourParam;
   }
 ...
 */
const longerString = (param1 ="", param2 ="" ) => {
